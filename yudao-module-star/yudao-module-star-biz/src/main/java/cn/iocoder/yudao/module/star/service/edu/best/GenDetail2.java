...
public class GenDetail2 {
    ...
    private static final String ADMISSION_INFO_COOKIE = "bestieubSessionId=6858bbe6d921f26ea50107ee; JSESSIONID=279A2BBDEFF5EEC928023F60348A29D5";
    ...
    private static final String APPLICATION_AGENCY_BEARER_TOKEN = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0ZW5hbnRXZWNoYXRPbk9mZiI6MSwidXNlcl9uYW1lIjoiNjg1OGJjNmNkN2ViZTU0MTViZGIxNDA2IiwidGVuYW50RW1haWxPbk9mZiI6MCwibGFuZ3VhZ2UiOiJjbiIsInRlbmFudFNuYW1lIjoi5bm_5bee56eR5a2m5Z-O54ix6I6O5aSW57GN5Lq65ZGY5a2Q5aWz5a2m5qCh77yIMu-8iSIsImNsaWVudF9pZCI6ImJlc3R1YiIsInN0dWRlbnRJZCI6IiIsInRlbmFudFNtc09uT2ZmIjowLCJsb2dpbkxvZ0lkIjoiNjg1OGM0NTBkN2ViZTU0MTViZGIxOTA2Iiwib2F1dGhJZCI6IjY4NThiYzZjZDdlYmU1NDE1YmRiMTQwNiIsInRlbmFudEVuYW1lIjoiIiwic2NvcGUiOlsiYWxsIl0sInRlbmFudEFsbE5hbWUiOiLlub_.dIu0AUDhJ1vRnNukxMd-h9UevNSHwCRNlRf4_o8y4no";
    ...
    private static String sendResourceRequest(String id) throws Exception {
        ...
        connection.setRequestProperty("content-type", "application/json");
        connection.setRequestProperty("Cookie", "bestieubSessionId=6858bbe6d921f26ea50107ee; JSESSIONID=410414918DC85EEAD5F9D205E405B66C");
    ...
    private static String sendApplicationAgencyRequest(String id) throws Exception {
        ...
        connection.setRequestProperty("cache-control", "no-cache");
        connection.setRequestProperty("Cookie", APPLICATION_AGENCY_COOKIE);
        connection.setRequestProperty("pragma", "no-cache");
        connection.setRequestProperty("priority", "u=1, i");
        connection.setRequestProperty("referer", "https://gzkxc.bestieu.com/new-web/schoolDetail/detail/" + id + "?title=UM");
        connection.setRequestProperty("sec-ch-ua", "\"Google Chrome\";v=\"137\", \"Chromium\";v=\"137\", \"Not/A)Brand\";v=\"24\"");
